  ...
  <div id="aCoursesList" class="bg-fa of">
    ...
    <section class="container">
      <section class="path-wrap txtOf hLh30">
        ...
        \
        <a href="#" title class="c-999 fsize14">{{ courseWebVo.subjectOne }}</a>
        \
        <span class="c-333 fsize14">{{courseWebVo.subjectTwo}}</span>
      </section>
      <div>
        ...
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            ...
            <section class="c-attr-mt c-attr-undis">
              <span class="c-fff fsize14">主讲： {{courseWebVo.photographerName}}&nbsp;&nbsp;&nbsp;</span>
            </section>
              ...
              <section class="stud-act-list">
                <ul style="height: auto;">
                  <li>
                    <div class="u-face">
                      <a href="#">
                        <img :src="courseWebVo.avatar" width="50" height="50" :alt="courseWebVo.photographerName">
                      </a>
                    </div>
                    <section class="hLh30 txtOf">
                      <a class="c-333 fsize16 fl" href="#">{{courseWebVo.photographerName}}</a>
                    </section>
